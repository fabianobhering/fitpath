...
const std::string baseDirLinks = "../../inst/links/hall-60/w-htc-provision/4s-1_5M/";
const std::string baseDirInputFitpath = "../inst/links/hall-60/w-htc-provision/4s-1_5M/";
const std::string baseDirEvalvid = "../../inst/evalvid/hall-60/w-htc-provision/4s-1_5M/";
const std::string baseDirOutputFitpath = "../../inst/newILS-provision/0new-route300_";
...
void RecallEtx (int transmittingSources, int numNodes, int inst, int refId){
    ...
    if (file0.is_open()) {
        ...
        std::ifstream file1 ("config-initialization2-provision");
        if (file1.is_open()){
            std::string line;
            ...
            std::cerr << "Error opening file1 config-initialization2-provision" << std::endl;
        }
        file0.close();  
    } else {
...
void CallInputFitPath (int numNodes, int inst, int refId, NodeContainer adhocNodes, Ipv4InterfaceContainer adhocInterfaces, uint16_t pktSizeEval){ 
    ...
    std::ifstream file2("config-initialization2-provision"); 
    ...
    if (file2.is_open()){
        ...
        std::cerr << "Error opening file2 config-initialization2-provision" << std::endl;
    }
    ...
    sprintf(command, "cd ../../FITPATH2-provision/ && ./heuristicILS_mate %s%ds-links300_%d-%d-ref%d %d %d %d", 
