...
//							otherPacket->ETA = 0.025833333 * GRAPH_MULTIPLIER; // First backoff: 15.5 slots.
        ...
        t_burst_step* burst_patterns[] = { pattern_flow0, pattern_flow1, pattern_flow0, pattern_flow1 };
        int patterns_num_steps[] = { 1, 1, 1,1 }; // Quantidade de passos definidos em t_burst_step em cada padrão
